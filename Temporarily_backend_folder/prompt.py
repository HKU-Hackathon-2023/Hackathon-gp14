...
def get_topic_checklist_instructions(topic: str) -> int:
    ...
    prompt = f"""
    Your student is an extreme beginner. If you are asked to make a teaching plan on {topic}, as the topic of week 1 of the course. What are the items would you teach in this two hour? 
    ...
    return [SystemMessage(content="Output your response item by item seperate by comma."),
            HumanMessage(content=prompt)]

def teaching_instruction(student_special_education_need, teaching_instruction: str):
